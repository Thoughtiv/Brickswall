    ...
    switch (currentPage) {
      ...
      case 'projects':
        return (settings?.show_projects === 'true')
          ? <Projects onOpenEstimate={handleOpenEstimate} initialFilter={projectFilter} initialProject={initialProject} />
          : <Home setCurrentPage={setCurrentPage} navigateToService={navigateToService} navigateToProject={navigateToProject} onOpenEstimate={handleOpenEstimate} settings={settings} />;
      case 'packages':
